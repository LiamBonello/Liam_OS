...
Stage: higher-half handoff probe
Multiboot2: ok
Bootloader: ...
...
```txt
Higher-half handoff ready: 1
Higher-half handoff result ok: 1
Higher-half handoff scratch ok: 1
