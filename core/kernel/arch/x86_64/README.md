...
Stage: paging active + descriptor
Multiboot2: ok
Bootloader: ...
...
Paging builder ok: 1
Paging activation builder ready: 1
Paging activation CR3 changed: 1
Paging activation active matches builder: 1
...
7. Port paging and memory layout to 64-bit addresses. Started with boot-context layout, PMM planning diagnostics, an isolated PMM allocator smoke test, bootstrap paging-state diagnostics, a smoke-validated higher-half/direct-map plan, smoke-validated C-owned page tables, and CR3 activation of those tables.
