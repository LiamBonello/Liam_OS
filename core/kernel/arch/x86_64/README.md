...
6. Add x86_64 GDT/IDT/interrupt handling. Started with a maintained GDT, loaded TSS, critical-exception IST routing, page-fault diagnostics, panic-halt readiness, an opt-in invalid-opcode exception self-test, and exception IDT.
