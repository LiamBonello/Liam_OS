...
void x86_64_exception_handler(u64 vector, u64 error_code)
{
    ...
    x86_64_console_write_at("x86_64 exception", 12, 0);
    x86_64_console_write_at(name, 13, 0);
    x86_64_console_write_hex64(14, 0, "Vector: 0x", vector);
    x86_64_console_write_hex64(15, 0, "Error code: 0x", error_code);
