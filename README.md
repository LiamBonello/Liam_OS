...
`make x86_64-run` routes COM1 serial output to the terminal. Expected x86_64 serial markers include `IRQ interrupts enabled: 0`, `IRQ legacy PIC remapped: 1`, `IRQ all masked: 1`, `IRQ policy ok: 1`, `Runtime entry ok: 1`, and `Desc/IST ok: 1`.
