...
`make x86_64-run` routes COM1 serial output to the terminal. Expected x86_64 serial markers include `IRQ gates installed: 16`, `IRQ gates ok: 1`, `IRQ legacy PIC remapped: 1`, `PIT IRQ0 unmasked: 1`, `PIT waited ticks: 3`, `PIT timer ok: 1`, `Keyboard IRQ1 unmasked: 1`, `Keyboard ready ok: 1`, `Paging builder PMM backed: 1`, `Paging builder table pages: 8`, `Paging builder allocation ok: 1`, `Paging builder ok: 1`, `Heap PMM backed: 1`, `Heap direct map ok: 1`, `Heap alignment ok: 1`, `Heap pattern ok: 1`, `Heap smoke ok: 1`, `Runtime entry ok: 1`, and `Desc/IST ok: 1`. Pressing a key in the QEMU window should print `x86_64 keyboard IRQ received`, `Keyboard scancode: 0x...`, and `Keyboard ascii: ...` over serial for translated keypresses.
