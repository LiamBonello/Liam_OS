...
An x86_64 architecture path is now scaffolded for staged migration planning. It can build an experimental ELF64 kernel artifact and an experimental Multiboot2 long-mode ISO with an early freestanding C entry, VGA diagnostics, COM1 serial output, and parsed Multiboot2 boot information. The default stable Core build remains i386.
